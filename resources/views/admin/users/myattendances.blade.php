                ...
                <div class="col-md-12">
                    @if ($needApproval > 0)
                        <div class="alert alert-warning" role="alert">
                            ...
                            butuh validasi pengembangan karyawan <a class="btn btn-primary"
                                href="{{ route('admin.employee-developments.index') }}">
                                Klik disini!
                            </a>
                        </div>
                    @endif
        ...
        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    <div class="table-responsive">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($scan_logs as $scanlog)
                                                    @php
                                                        ...
                                                        if ($previousDate !== null && $previousDate != $currentDate) {
                                                            ...
                                                            echo '<td>' .
                                                                formatTotalTimeInSeconds(
                                                                    calculateTotalHoursInSeconds($scanTimes),
                                                                ) .
                                                                '</td>';
                                                ...
                                                @if (!empty($previousDate))
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ formatTotalTimeInSeconds(calculateTotalHoursInSeconds($scanTimes)) }}
                                                        </td>
                                                    </tr>
                                        ...
                                        } @endphp @phpfunction calculateTotalHours($times)
                                            {
                                                if (count($times) < 2) {
                                                    return '0';
                                                }
            ...
            <div class="col-md-6">
                <div class="small-box bg-warning">
                    ...
                    <a href="#" class="small-box-footer">Jika ada perbedaan/kesalahan data. Silahkan konfirmasikan
                        ke BAS. <i class="fa fa-info-circle" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
