                        ...
                        <h3>
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                  <button class="nav-link active" id="terlambat-tab" data-toggle="tab" data-target="#terlambat" type="button" role="tab">
                                   <small>Datang Terlambat</small> 
                                </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                  <button class="nav-link" id="pulang-cepat-tab" data-toggle="tab" data-target="#pulang-cepat" type="button" role="tab">
