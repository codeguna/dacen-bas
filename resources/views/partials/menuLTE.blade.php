<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item {{ request()->is('admin/lecturers/*') ||
        ...
        <li class="nav-item {{ request()->is('admin/educational-staffs/*') ||
        ...
        <li class="nav-item {{ request()->is('admin/scan-logs') ||
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.scanlogs.detail') }}" class="nav-link {{ request()->is('admin/scan-log/detail') ||
                            request()->is('admin/scan-log/detail/*') ||
                            request()->is('admin/scan-log/detail/filter') ||
                            request()->is('admin/scan-log/detail/filter/*')
                                ? 'active'
        ...
        <li class="nav-item {{ request()->is('admin/homebases/*') ||
        ...
        @endcan
        @can('users_manage')
        <li class="nav-item {{ request()->is('admin/roles/*') ||
                ...
                request()->is('admin/user/set_users_pin/*')
                    ? 'menu-open'
                    : '' }}">
            <a href="#" class="nav-link {{ request()->is('admin/roles/*') ||
                    request()->is('admin/roles') ||
                    request()->is('admin/permissions') ||
                    request()->is('admin/permissions/*') ||
                    request()->is('admin/users') ||
